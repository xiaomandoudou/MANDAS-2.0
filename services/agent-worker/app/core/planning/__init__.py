...
<create_file path="/home/ubuntu/repos/MANDAS-2.0/services/agent-worker/app/core/planning/planner.py">
...
class TaskPlanner:
    ...
    async def create_plan(self, task_description: str, available_tools: List[str], task_id: str) -> TaskPlan:
        ...
        try:
            ...
            llm_response = await self.llm_router.route_request({
...
"""
    ...
    def _parse_plan(self, llm_response: Dict[str, Any], task_id: str) -> TaskPlan:
